...
<div class="content_section light_grey">
	<div id="container">
		<div id="search_results_section">
			...
			if(isset($_GET['button_main_search']) && $_GET['input_main_search'] != "") {
				...
				$sqlwherename = $sqlwhereshops = $sqlwheretype = $sqlprice = "";
					...
					if($search_text != "") {
						...
						if($products == "special") {
							...
							$sqlwheretype = " AND (morelowrprice is not null)";
						...
						if($min_price != "" && $max_price != "") {
							$sqlprice = " AND (price > ".$min_price." AND price < ".$max_price.")"; 
						} else if($min_price != "" && $max_price == "") {
							$sqlprice = " AND (price > ".$min_price.")";
						} else if($min_price == "" && $max_price != "") {
							$sqlprice = " AND (price < ".$max_price.")";
						}  
					} 
				...
				//
				$sql = "SELECT * FROM scraper_products WHERE".$sqlwherename.$sqlwhereshops.$sqlwheretype.$sqlprice." AND dateretrieved='18/1/2018' ORDER BY name OFFSET :offset_bv ROWS FETCH NEXT 10 ROWS ONLY";
				...
				if(isset($_GET['input_main_search']) && $search_text != "") {	
						 ...
						 //if(isset($_GET['min_price'])) {
							//if($min_price_select < oci_result($stmt,"PRICE") && $max_price_select > oci_result($stmt,"PRICE")) {
								echo "<div class='result_tile'><h1>".oci_result($stmt,"NAME")."</h1><table class='result_table'><tr><td><strong>Current price</strong> <br><strong>Regular price</strong> <br><strong>Special</strong> <br><strong>Discount percentage</strong> <br>";
									if(oci_result($stmt,"MORELOWRPRICE") != "") {echo "<strong>Multibuy</strong> <br>";}
									...
									if(oci_result($stmt,"MORELOWRPRICE") != "") {echo oci_result($stmt,"MORELOWRPRICE")."<br>";}
									echo oci_result($stmt,"STORE")."<br>".oci_result($stmt,"BRAND")."</td><td align=\"right\" class=\"td_img\"><img height='150' width='150' class='results_img' src='".oci_result($stmt,"LARGEIMAGEFILE")."'/></td></tr></table></div>";
							//} else {
							//	$z++;
							//}
						 //} 
					...
					$sql = "SELECT * FROM scraper_products WHERE".$sqlwherename.$sqlwhereshops.$sqlwheretype.$sqlprice." AND dateretrieved='18/1/2018'";
