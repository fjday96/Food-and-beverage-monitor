...
<div class="content_section light_grey">
	<div id="container">
		...
		<?php
			if($_SESSION['admin'] == 't') {
				echo "<h2>View user accounts</h2>";
				echo "<p>As an administrator, you can view all currently registered accounts.</p>";
				echo "<a href=\"#\"><div class=\"accounts_button\">View all users</div></a>";
			}
		?>
	</div>
</div>
